...
import com.office.future.futureoffice.Events.OnListFragmentInteractionListener;
...
public class MyEventRecyclerViewAdapter extends RecyclerView.Adapter<MyEventRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        calendar.setTimeInMillis(holder.mItem.getBegin());
        DateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
        holder.date.setText(formatter.format(calendar.getTime()));
        formatter = new SimpleDateFormat("HH:mm");
        holder.begin.setText(formatter.format(calendar.getTime()));
        calendar.setTimeInMillis(holder.mItem.getEnd());
        holder.end.setText(formatter.format(calendar.getTime()));
        holder.location.setText(holder.mItem.getLocation());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            location = (TextView) view.findViewById(R.id.localization);
